    ...
    loop {
        ...
        match ev {
            Event::Key(KeyEvent {
                ...
                KeyCode::Char('a') if modifiers.contains(KeyModifiers::CONTROL) && cursor_pos > 0 => {
                        execute!(stdout, cursor::MoveLeft(cursor_pos as u16))?;
                        cursor_pos = 0;
                    }
                ...
                KeyCode::Char('u') if modifiers.contains(KeyModifiers::CONTROL) && cursor_pos > 0 => {
                        execute!(stdout, cursor::MoveLeft(cursor_pos as u16))?;
                ...
                KeyCode::Char('w') if modifiers.contains(KeyModifiers::CONTROL) && cursor_pos > 0 => {
